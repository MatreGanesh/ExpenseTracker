          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-start items-center ">
              <div className="flex justify-center flex-row w-full ">
                ...
                <p
                  className="inline-flex space-x-1 ml-auto font-bold items-center px-1 pt-1 text-sm text-gray-500 hover:text-gray-700"
                > <span>Hi,</span>
                  <span>
                    {(() => {
                      const user = localStorage.getItem('userInfo');
                      if (!user) return ""; // or some default text like "Guest"
                      try {
                        const userObj = JSON.parse(user);
                        return userObj.username || ""; // safely access username
                      } catch {
                        return ""; // if JSON parsing fails
                      }
                    })()}
                  </span>
                  <span>!</span>
