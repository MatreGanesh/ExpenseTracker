    ...
    <>
      ...
      <div className="py-20 px-4">
        ...
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Step 2 */}
          <div className="flex flex-col items-center text-center">
            <Link to={'/add-transaction'} className="p-4 rounded-full bg-green-500 text-white mb-4">
          ...
          {/* Step 3 */}
          <div className="flex flex-col items-center text-center">
            <Link to={'/dashboard'} className="p-4 rounded-full bg-yellow-500 text-white mb-4">
